          ...
          <div class="container-fluid pe-0">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <li class="nav-item d-flex align-items-center">
                <a class="btn btn-round btn-sm mb-0 btn-outline-primary me-2"  href="https://starbright.com.ph/">Website</a>
              </li>
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" action="process/login.php" method="POST">
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" class="form-control" name="loginIdentifier" placeholder="Email" aria-label="Email" aria-describedby="email-addon">
                    </div>
