        ...
        <div class="row">
            ...
            <div class="col-md-6">
               ...
               <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="productType" name="type" placeholder="Enter product type" required>
                </div>
                <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="productUnit" name="unit" placeholder="Enter unit (e.g., kg, lb, pcs)" required>
                </div>
                <div class="mb-3">
